...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/facilities/{facility_id}/patients": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "items": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/presentation_patient.PatientResponse"
                                }
                            }
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presentation_patient.CreatePatientRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/presentation_patient.CreatePatientResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "presentation_patient.CreatePatientRequest": {
            "type": "object",
            "required": [
                "address_id",
                "area_id",
        ...
        "presentation_patient.CreatePatientResponse": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "presentation_patient.PatientResponse": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
